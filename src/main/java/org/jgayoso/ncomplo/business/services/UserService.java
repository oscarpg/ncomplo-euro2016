...
public class UserService {
  ...
  @Transactional
  public User registerFromInvitation(
      final Integer invitationId,
      final String login,
      final String name,
      final String email,
      final Integer leagueId,
      final String password)
      throws LeagueClosedException, InvalidLoginException {
    ...
    final String hashedNewPassword = this.passwordEncryptor.encryptPassword(password);
  ...
  public void forgotPassword(final String email) {
    ...
    String fptUrl =
        this.baseUrl + "/forgot-password-reset/" + forgotPwdToken.getLogin() + "/" + forgotPwdToken.getToken();

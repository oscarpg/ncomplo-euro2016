  ...
  public void updateCurrentGame() {
    ...
    for (final Competition competition : competitions) {
      ...
      final List<Game> todayGames =
          this.gameRepository.findByCompetitionAndDateBetweenOrderByDate(competition, todayMorning, todayEvening);
      ...
      try {
        ...
        final ResponseEntity<MatchVO[]> responseEntity = restTemplate.getForEntity(uri, MatchVO[].class);
